...
#Region "Contructor"
    ...
    Public Sub GENERAR_FACTURES_TLY()
        ...
        While oDataReader.Read()
            ...
            xCompany = "TOKYO YA"   '''''oDataReader("CompnyName").ToString
            xAddress = oDataReader("street").ToString    ''' oDataReader("CompnyAddr").ToString
        ...
        ''''ls = ls & " WHERE T1.QryGroup1 = 'Y' "         ' Cliente con Flag Facturas VOXEL
        ls = ls & " WHERE (T1.QryGroup1 = 'Y' or  (T1.QryGroup3 = 'Y' and year(DocDate) >= 2023) ) "
        ...
        Try
            ...
            Do While Not oRecordset.EOF
                ...
                If Trim(xDirOutBox) <> "" Then
                    sPath = xDirOutBox & "\"
                End If
                ''' nou per tokyo direcció de la oadm 
                ''' 
    ...
    Private Sub XML_Linea(ByRef oXML As Xml.XmlDocument, _
        ...
        ' 
        ls = ""
        ls = ls & "  select  distinct  T2.DocNum as baseref,t2.DocDate as datacomanda, isnull(T3.NumAtCard,'') as DocNumPedido   "
        ls = ls & "  FROM OINV T0  "
        ...
        ls = ls & " left join rdr1 p3 on p3.docentry =  d1.baseentry  and p3.LineNum = d1.baseline"
        ls = ls & " left join ordr t3 on t3.docentry = p3.docentry"
        ...
        While oDataReader2.Read()
            ...
            Else
                ...
                oItem.Item(xLinia).Attributes("PORef").InnerText = oDataReader2("DocNumPedido").ToString
            End If
            '
            xLinia = xLinia + 1
            '
